...
+ *Action*: Check the Controller Manager logs with `kubectl -n kubermatic logs -f controller-manager-*` and 
    the CRD of the cluster with `kubectl get clusters <clusterID> -o yaml`
