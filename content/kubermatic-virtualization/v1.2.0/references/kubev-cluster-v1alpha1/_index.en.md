...
date = 2026-07-02T11:28:07+01:00
weight = 11
+++
## v1alpha1

* [APIEndpoint](#apiendpoint)
* [ClusterNetworkConfiguration](#clusternetworkconfiguration)
* [CommonInstancetypesDeploymentConfiguration](#commoninstancetypesdeploymentconfiguration)
...
| kubelet | Kubelet holds per-node kubelet configuration options that override the cluster-level defaults. | [KubeletConfig](#kubeletconfig) | false |
...
| kubeletConfig | KubeletConfig defines cluster-wide kubelet configuration applied to all nodes. Per-node overrides can be set via HostConfig.Kubelet. | [KubeletConfig](#kubeletconfig) | false |
...
| migrations | Migrations holds live-migration tuning parameters applied cluster-wide. | *[MigrationsConfiguration](#migrationsconfiguration) | false |
| commonInstancetypesDeployment | CommonInstancetypesDeployment controls whether the common-instancetypes bundle is deployed. | *[CommonInstancetypesDeploymentConfiguration](#commoninstancetypesdeploymentconfiguration) | false |
| permittedHostDevices | PermittedHostDevices declares PCI devices that may be passed through to VMs. | *[PermittedHostDevices](#permittedhostdevices) | false |
...
| Field | Description | Scheme | Required |
| ----- | ----------- | ------ | -------- |
| pciHostDevices | PciHostDevices is the list of PCI devices allowed for passthrough. | [][PciHostDevice](#pcihostdevice) | false |
