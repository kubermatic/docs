...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-manager-ee --version=v1.3.6 --untardir "." --untar
## Apply CRDs
...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-manager --version=v1.3.6 --untardir "." --untar
## Apply CRDs
