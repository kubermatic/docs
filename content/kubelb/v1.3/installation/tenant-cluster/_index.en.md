...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-ccm-ee --version=v1.3.9 --untardir "." --untar
## Apply CRDs
...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-ccm --version=v1.3.9 --untardir "." --untar
## Apply CRDs
