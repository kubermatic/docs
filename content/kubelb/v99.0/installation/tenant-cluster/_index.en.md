...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-ccm-ee --version=v99.0.0 --untardir "." --untar
## Apply CRDs
...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-ccm --version=v99.0.0 --untardir "." --untar
## Apply CRDs
