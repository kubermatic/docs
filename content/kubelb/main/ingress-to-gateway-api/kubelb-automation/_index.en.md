...
```sh
helm upgrade --install kubelb-ccm oci://quay.io/kubermatic/helm-charts/kubelb-ccm --version=v1.3.7 --namespace kubelb -f values.yaml --create-namespace
```
...
```sh
helm upgrade --install kubelb-ccm oci://quay.io/kubermatic/helm-charts/kubelb-ccm-ee --version=v1.3.7 --namespace kubelb -f values.yaml --create-namespace
```
