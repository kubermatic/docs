...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-manager-ee --version=v1.1.2 --untardir "." --untar
...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-manager --version=v1.1.2 --untardir "." --untar
## Create and update values.yaml with the required values.
