...
For provisioning Kubernetes clusters with the [Azure cloud provider](https://github.com/kubermatic/machine-controller/tree/release/v1.12/pkg/cloudprovider/provider/azure) Kubermatic KubeOne needs a service account. Please follow the following steps to create a matching service account and the roles:
