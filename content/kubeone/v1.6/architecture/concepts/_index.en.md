...
[terraform-scripts]: https://github.com/kubermatic/kubeone/tree/release/v1.6/examples/terraform
[aws-output-tf]: https://github.com/kubermatic/kubeone/blob/release/v1.6/examples/terraform/aws/output.tf
