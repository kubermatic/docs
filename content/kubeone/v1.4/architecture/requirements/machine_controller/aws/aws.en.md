...
```json
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": "arn:aws:iam::YOUR_ACCOUNT_ID:role/CLUSTER_NAME-*"
        },
        {
            "Effect": "Allow",
            "Action": [
            ...
            "Resource": "arn:aws:iam::YOUR_ACCOUNT_ID:instance-profile/CLUSTER_NAME-*"
        },
        {
            "Effect": "Allow",
            "Action": [
...
- CLUSTER_NAME is the name of your kubeone cluster
