...
[terraform-scripts]: https://github.com/kubermatic/kubeone/tree/release/v1.3/examples/terraform
[aws-output-tf]: https://github.com/kubermatic/kubeone/blob/release/v1.3/examples/terraform/aws/output.tf
