...
#   https://docs.kubermatic.com/kubeone/v1.7/architecture/concepts/#kubermatic-machine-controller
...
output "kubeone_hosts" {
  ...
  value = {
    control_plane = {
      ...
      # providers:
      #   https://docs.kubermatic.com/kubeone/v1.7/architecture/compatibility/
