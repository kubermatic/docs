...
![Download config button in the top right corner](/img/kubermatic/v2.23/tutorials/cluster_details_btn.png?classes=shadow,border "Download config button in the top right corner")
...
![Select Revoke Token](/img/kubermatic/v2.23/tutorials/revoke_token_cluster.png?classes=shadow,border "Select Revoke Token")
...
![Revoke the token](/img/kubermatic/v2.23/tutorials/revoke_token_dialog.png?classes=shadow,border "Revoke the token")
