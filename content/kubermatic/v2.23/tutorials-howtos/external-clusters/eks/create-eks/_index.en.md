...
![Select AKS Provider](/img/kubermatic/v2.23/tutorials/external_clusters/eks_selection.png "Select EKS Provider")

- Provide the credentials:

![Select Preset](/img/kubermatic/v2.23/tutorials/external_clusters/select_eks_preset.png "Select Preset")
...
![Configure Cluster](/img/kubermatic/v2.23/tutorials/external_clusters/eks_settings.png "Configure Cluster")
...
![Add Node Group](/img/kubermatic/v2.23/tutorials/external_clusters/add_md.png "Add Node Group")

![Create Node Group](/img/kubermatic/v2.23/tutorials/external_clusters/create_eks_md.png "Create Node Group")
