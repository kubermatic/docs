...
![Access Admin Panel](/img/kubermatic/v2.23/ui/admin_panel.png?classes=shadow,border "Accessing the Admin Panel")
...
![Admin OPA Options](/img/kubermatic/v2.23/ui/opa_admin_options.png?classes=shadow,border "Admin OPA Options")

The Admin Panel also offers you the possibility to specify Constraint Templates.

![Constraint Templates](/img/kubermatic/v2.23/ui/opa_admin_ct_view.png?classes=shadow,border "Constraint Templates")
...
![Cluster Details View](/img/kubermatic/v2.23/ui/opa_cluster_view.png?classes=shadow,border "Cluster Details View")
...
![OPA Integration during Cluster Creation](/img/kubermatic/v2.23/ui/opa_enable.png?classes=shadow,border "OPA Integration during Cluster Creation")
...
![Cluster Details Ellipsis Menu](/img/kubermatic/v2.23/ui/edit_cluster_menu.png?classes=shadow,border "Cluster Details Ellipsis Menu")

In the appearing dialog, you can now enable/disable the OPA Integration.

![Edit Cluster Dialog](/img/kubermatic/v2.23/ui/edit_cluster_dialog.png?classes=shadow,border "Edit Cluster Dialog")
...
![Add Constraint Template](/img/kubermatic/v2.23/ui/opa_admin_add_ct.png?classes=shadow,border&height=350px "Constraint Template Add Dialog")
...
![Edit Constraint Template](/img/kubermatic/v2.23/ui/edit_constraint_template.png?classes=shadow,border "Cluster Details View")
...
![Constraints](/img/kubermatic/v2.23/ui/opa_constraints_cluster.png?classes=shadow,border "Constraints")
...
![Add Constraints Dialog](/img/kubermatic/v2.23/ui/opa_add_constraint.png?classes=shadow,border "Add Constraints Dialog")
...
![Constraints](/img/kubermatic/v2.23/ui/cluster_opa_constraints_overview.png?classes=shadow,border "Constraints")

It also shows you possible violations. Click on the row to expand the view and to see all violations in detail.

![Violations](/img/kubermatic/v2.23/ui/opa_created_constraints_violations.png?classes=shadow,border "Violations")
...
![Disabled Constraint Spec](/img/kubermatic/v2.23/ui/disabled_constraint_spec.png?classes=shadow,border "Disabled Constraint Spec")

Disabled Kubermatic Constraint on a Cluster is blurred to differentiate between Enabled and Disabled Constraints

![Disabled Constraint](/img/kubermatic/v2.23/ui/cluster_disabled_constraint.png?classes=shadow,border "Disabled Constraint")
...
![Disabled Default Constraint](/img/kubermatic/v2.23/ui/default-constraint-default-true.png?height=400px&classes=shadow,border "Disabled Default Constraint")
...
![Allowed Registries Create](/img/kubermatic/v2.23/ui/add_allowed_registry.png?classes=shadow,border "Add Allowed Registry")
...
![Allowed Registries Default Constraint](/img/kubermatic/v2.23/ui/allowed_registry_default_constraint.png?classes=shadow,border "Allowed Registry Default Constraint")
...
![Gatekeeper Config](/img/kubermatic/v2.23/ui/opa_config.png?classes=shadow,border "Gatekeeper Config")

Click on this button to create a config. A new dialog will appear, where you can insert your spec:

![Add Gatekeeper Config](/img/kubermatic/v2.23/ui/opa_add_config.png?height=350px&classes=shadow,border "Add Gatekeeper Config")
...
![Gatekeeper Config](/img/kubermatic/v2.23/ui/opa_config_overview.png?classes=shadow,border "Gatekeeper Config")
