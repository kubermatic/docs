...
You can use the external IP to ssh into the node using the SSH key you added as described in [add an SSH key](../../../tutorials_howtos/project_and_cluster_management/) under project management section.
