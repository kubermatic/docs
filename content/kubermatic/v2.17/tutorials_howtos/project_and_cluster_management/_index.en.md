...
![Cluster Deletion Button in the top right corner](/img/kubermatic/v2.17/tutorials/cluster_details_btn.png?classes=shadow,border "Cluster Deletion Button in the top right corner")
...
![Cluster overview with highlighted add button](/img/kubermatic/v2.17/tutorials/cluster_details_btn.png?classes=shadow,border "Cluster overview with highlighted add button")
