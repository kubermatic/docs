...
![Pod Security Policy Selection during Cluster Creation](/img/kubermatic/v2.24/ui/admission_plugins.png?height=400px&classes=shadow,border "Pod Security Policy Selection during Cluster Creation")

For existing clusters, it's also possible to enable/disable PSP:

![Edit Cluster](/img/kubermatic/v2.24/ui/psp_edit.png?classes=shadow,border "Edit Cluster")
