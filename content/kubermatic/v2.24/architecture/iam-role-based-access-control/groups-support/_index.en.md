...
![Group Bindings Overview](/img/kubermatic/v2.24/architecture/group-rbac-view.png)

From this view, new group bindings can be created via the "Add Group" button.

![Group Binding Wizard](/img/kubermatic/v2.24/architecture/group-rbac-add.png)
