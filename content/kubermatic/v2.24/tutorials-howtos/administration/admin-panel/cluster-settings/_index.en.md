...
![](/img/kubermatic/v2.24/ui/defaults_cluster_settings.png?classes=shadow,border)
...
![](/img/kubermatic/v2.24/ui/cleanup_on_cluster_deletion.png?classes=shadow,border)

This section controls cluster cleanup settings available inside cluster delete dialog.

![](/img/kubermatic/v2.24/ui/delete_cluster_dialog.png?classes=shadow,border)
...
![](/img/kubermatic/v2.24/ui/machine_deployment.png?classes=shadow,border)
...
![](/img/kubermatic/v2.24/ui/wizard_initial_nodes_step.png?classes=shadow,border)


## Limits

![](/img/kubermatic/v2.24/ui/interface_limits.png?classes=shadow,border)
...
![](/img/kubermatic/v2.24/ui/user_projects_limit.png?classes=shadow,border)
...
![](/img/kubermatic/v2.24/ui/resource_filter.png?classes=shadow,border)
