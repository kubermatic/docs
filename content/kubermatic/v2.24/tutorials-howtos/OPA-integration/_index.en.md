...
![Cluster Details View](/img/kubermatic/v2.24/ui/opa_cluster_view.png?height=500px&classes=shadow,border "Cluster Details View")

![Constraints Cluster View](/img/kubermatic/v2.24/ui/opa_constraints_cluster.png?classes=shadow,border "Constraints Cluster View")
...
![Add Constraints Dialog](/img/kubermatic/v2.24/ui/opa_add_constraint.png?height=350px&classes=shadow,border "Add Constraints Dialog")
...
![Default Constraints](/img/kubermatic/v2.24/ui/default-constraint-admin.png?height=300px&classes=shadow,border "Default Constraints")
...
![Disable Default Constraint](/img/kubermatic/v2.24/ui/default-constraint-on.png?height=200px&classes=shadow,border "Disable Default Constraint")

Enable the constraint by clicking the same button
![Enable Default Constraint](/img/kubermatic/v2.24/ui/disabled-default-constraint.png?height=200px&classes=shadow,border "Enable Default Constraint")
...
![Allowed Registry Default Constraint](/img/kubermatic/v2.24/ui/allowed_registry_default_constraint.png?classes=shadow,border "Allowed Registry Default Constraint")
