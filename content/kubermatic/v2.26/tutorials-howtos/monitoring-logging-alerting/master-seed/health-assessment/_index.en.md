...
![Kubernetes Dashboards in Grafana](images/kubernetes-dashboards.png?classes=shadow,border)
...
![User Clusters status](images/user-clusters.png?classes=shadow,border)
...
![Machine Controller status](images/machine-controller.png?classes=shadow,border)
...
![KKP Controllers Status](images/kkp-controllers.png?classes=shadow,border)
