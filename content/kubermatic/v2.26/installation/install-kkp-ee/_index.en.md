...
{{% notice info %}}
In order to maintain upgrade compatibility, deploying the default-app-catalog will overwrite any prior [default ApplicationDefinitions](https://github.com/kubermatic/kubermatic/tree/release/v2.26/pkg/ee/default-application-catalog/applicationdefinitions).
{{% /notice %}}
