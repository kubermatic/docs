...
![Backup Destinations](/img/kubermatic/main/tutorials/backups/backup_destinations.png?classes=shadow,border "Backup Destinations Settings View")
...
![Add Backup Destination](/img/kubermatic/main/tutorials/backups/add_backup_destination.png?classes=shadow,border "Backup Destination Settings Add")

To edit, just click on the `Edit Destination` pen icon on the right

![Edit Backup Destination](/img/kubermatic/main/tutorials/backups/edit_backup_destination.png?classes=shadow,border "Backup Destination Settings Edit")
...
![Edit Credentials](/img/kubermatic/main/tutorials/backups/edit_backup_dest_credentials.png?classes=shadow,border "Backup Destination Credentials Edit")
...
![Set Default Destination](/img/kubermatic/main/tutorials/backups/set_backup_dest_as_default.png?classes=shadow,border "Set Backup Destination as Default")
