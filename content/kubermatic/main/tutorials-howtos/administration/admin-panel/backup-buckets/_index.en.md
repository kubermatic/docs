...
![Add Backup Destination](images/add-backup-destination.png?classes=shadow,border "Backup Destination Settings Add")

To edit, just click on the `Edit Destination` pen icon on the right

![Edit Backup Destination](images/edit-backup-destination.png?classes=shadow,border "Backup Destination Settings Edit")
...
![Edit Credentials](images/edit-backup-dest-credentials.png?classes=shadow,border "Backup Destination Credentials Edit")
...
![Set Default Destination](images/set-backup-dest-as-default.png?classes=shadow,border "Set Backup Destination as Default")
