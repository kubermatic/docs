...
![Backup Destinations](/img/kubermatic/main/tutorials/backups/backup-destinations.png?classes=shadow,border "Backup Destinations Settings View")
...
![Add Backup Destination](/img/kubermatic/main/tutorials/backups/add-backup-destination.png?classes=shadow,border "Backup Destination Settings Add")

To edit, just click on the `Edit Destination` pen icon on the right

![Edit Backup Destination](/img/kubermatic/main/tutorials/backups/edit-backup-destination.png?classes=shadow,border "Backup Destination Settings Edit")
...
![Edit Credentials](/img/kubermatic/main/tutorials/backups/edit-backup-dest-credentials.png?classes=shadow,border "Backup Destination Credentials Edit")
...
![Set Default Destination](/img/kubermatic/main/tutorials/backups/set-backup-dest-as-default.png?classes=shadow,border "Set Backup Destination as Default")
