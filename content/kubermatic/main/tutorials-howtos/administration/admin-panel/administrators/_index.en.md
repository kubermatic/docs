...
![Administrators](@/images/ui/admins.png?classes=shadow,border "Administrators View")
...
![Add Administrator](@/images/ui/admin-add.png?classes=shadow,border&height=200 "Administrator Add Dialog")
...
![Delete Administrator](@/images/ui/admin-delete.png?classes=shadow,border&height=200 "Administrator Delete Dialog")
