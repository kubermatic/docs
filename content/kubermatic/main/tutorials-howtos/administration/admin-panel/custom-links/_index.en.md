...
![Admin Panel](@/images/ui/custom-links.png?classes=shadow,border "Custom Links Settings")
...
![API Documentation](@/images/ui/api-docs.png?classes=shadow,border "API Documentation")
