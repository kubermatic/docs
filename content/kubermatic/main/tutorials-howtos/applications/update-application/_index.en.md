...
![Applications Tab](/img/kubermatic/common/applications/applications-edit-icon.png?classes=shadow,border "Applications edit button")
...
![Applications Tab](/img/kubermatic/common/applications/applications-edit-values.png?classes=shadow,border "Applications edit values and version")
