...
A [migration guide]({{< ref "./upgrade-helm-2-to-3" >}}) is provided.
...
* [Upgrading the Operator from 2.14 to 2.15]({{< ref "./kubermatic-operator" >}})
* [Migration from Helm to the Operator]({{< ref "./chart-migration" >}})
* [Upgrading the legacy Helm Chart]({{< ref "./kubermatic-chart" >}}) (EE)
