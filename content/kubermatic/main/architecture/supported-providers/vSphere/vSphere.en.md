...
* Role `k8c-user-tags`
  ...
  * Provides permission to create vSphere tags for a dedicated category which are need by KKP seed controller manager
  * Permissions
    * vSphere Tagging
      * Create vSphere Tag
      * Delete vSphere Tag
...
it creates and KKP would try to delete those tags who are assigned to the cluster it up upon cluster deletion. Thus, make
sure that, the assigned category, isn't shared across other lingering resources. {{% /notice %}}
