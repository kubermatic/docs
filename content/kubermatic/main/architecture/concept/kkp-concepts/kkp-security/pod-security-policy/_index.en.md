...
![Pod Security Policy Selection during Cluster Creation](/img/kubermatic/main/ui/admission-plugins.png?height=400px&classes=shadow,border "Pod Security Policy Selection during Cluster Creation")

For existing clusters, it's also possible to enable/disable PSP:

![Edit Cluster](/img/kubermatic/main/ui/psp-edit.png?classes=shadow,border "Edit Cluster")
