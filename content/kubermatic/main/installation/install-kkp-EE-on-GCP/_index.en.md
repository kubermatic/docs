+++
title = "Install Kubermatic Kubernetes Platform (KKP) EE on GCP"
date = 2018-04-28T12:07:15+02:00
description = "Learn how to install KKP Enterprise Edition (EE) into a pre-existing Kubernetes cluster on Google Cloud Platform (GCP)"
weight = 120
enterprise = true
+++
...
The installation procedure is identical to the [Community Edition]({{< ref "../install-kkp-CE-on-GCP" >}}), with the exception that
...
Follow the CE install guide on Google as normal, the remaining steps apply equally to the Enterprise Edition.

### Next Steps

* [Add a Seed cluster on GCP]({{< ref "./add-seed-cluster-ee-on-gcp" >}}) to start creating user clusters.
