...
![Service Account](/img/kubermatic/v2.25/ui/serviceaccount-overview.png?classes=shadow,border "Service Account")

Users can create many Service Accounts (SA) with unique names in the project scope.

![Create Service Account](/img/kubermatic/v2.25/ui/serviceaccount-add.png?classes=shadow,border "Create Service Account")
...
![Create Service Account](/img/kubermatic/v2.25/ui/serviceaccount-token.png?classes=shadow,border "Create Service Account")
...
![Manage Service Account](/img/kubermatic/v2.25/ui/serviceaccount-manage-token.png?classes=shadow,border "Manage Service Account")
