...
![Addons](/img/kubermatic/v2.25/ui/addons-overview.png?classes=shadow,border "Addons View")
...
![Addon Form](/img/kubermatic/v2.25/ui/addon-form.png?height=450px&classes=shadow,border "Addon Form")
...
```
{{< readfile "kubermatic/v2.25/data/addondata.go" >}}
```
