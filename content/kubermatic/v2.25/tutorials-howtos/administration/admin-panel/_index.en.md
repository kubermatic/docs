...
![](/img/kubermatic/v2.25/ui/admin-panel-access.png?height=300px&classes=shadow,border "Accessing the Admin Panel")

![](/img/kubermatic/v2.25/ui/panel.png?height=350px&classes=shadow,border "Admin Panel")
