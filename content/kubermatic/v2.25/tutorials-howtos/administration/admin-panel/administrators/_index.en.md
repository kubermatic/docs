...
![Administrators](/img/kubermatic/v2.25/ui/admins.png?classes=shadow,border "Administrators View")
...
![Add Administrator](/img/kubermatic/v2.25/ui/admin-add.png?classes=shadow,border&height=200 "Administrator Add Dialog")
...
![Delete Administrator](/img/kubermatic/v2.25/ui/admin-delete.png?classes=shadow,border&height=200 "Administrator Delete Dialog")
