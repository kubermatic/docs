...
![](/img/kubermatic/v2.25/ui/defaults-cluster-settings.png?classes=shadow,border)
...
![](/img/kubermatic/v2.25/ui/cleanup-on-cluster-deletion.png?classes=shadow,border)

This section controls cluster cleanup settings available inside cluster delete dialog.

![](/img/kubermatic/v2.25/ui/delete-cluster-dialog.png?classes=shadow,border)
...
![](/img/kubermatic/v2.25/ui/machine-deployment.png?classes=shadow,border)
...
![](/img/kubermatic/v2.25/ui/wizard-initial-nodes-step.png?classes=shadow,border)


## Limits

![](/img/kubermatic/v2.25/ui/interface-limits.png?classes=shadow,border)
...
![](/img/kubermatic/v2.25/ui/user-projects-limit.png?classes=shadow,border)
...
![](/img/kubermatic/v2.25/ui/resource-filter.png?classes=shadow,border)
