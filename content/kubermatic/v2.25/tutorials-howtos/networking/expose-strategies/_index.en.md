...
![KKP NodePort](/img/kubermatic/v2.25/concepts/architecture/expose-np.png?classes=shadow,border)
...
![KKP LoadBalancer](/img/kubermatic/v2.25/concepts/architecture/expose-lb.png?classes=shadow,border)
...
![KKP Tunneling](/img/kubermatic/v2.25/concepts/architecture/expose-tunnel.png?classes=shadow,border)
