...
![Cluster Settings - Network Configuration](/img/kubermatic/v2.25/tutorials/networking/ui-cluster-networking.png?classes=shadow,border "Cluster Settings - Network Configuration")
...
![Cluster Settings - Network Configuration](/img/kubermatic/v2.25/tutorials/networking/ui-cluster-cni.png?classes=shadow,border "Cluster Settings - Network Configuration")
...
![Edit CNI Values](/img/kubermatic/v2.25/tutorials/networking/edit-cni-app-values.png?classes=shadow,border "Edit CNI Values")
...
![Edit CNI Application](/img/kubermatic/v2.25/tutorials/networking/edit-cni-app.png?classes=shadow,border "Edit CNI Application")
...
![Cluster Details](/img/kubermatic/v2.25/tutorials/networking/ui-cni-upgrade-available.png?classes=shadow,border "Cluster Details")

![Cluster Details - CNI Plugin Version Dialog](/img/kubermatic/v2.25/tutorials/networking/ui-cni-upgrade-dialog.png?classes=shadow,border "Cluster Details - CNI Plugin Version Dialog")
...
![Cluster Settings - Advanced Network Configuration](/img/kubermatic/v2.25/tutorials/networking/ui-cluster-networking-advanced.png?classes=shadow,border "Cluster Settings - Network Configuration")
...
![Cluster Settings - Network Configuration](/img/kubermatic/v2.25/tutorials/networking/ui-cluster-konnectivity.png?classes=shadow,border "Cluster Settings - Network Configuration")
...
![Cluster Details - Edit Cluster Dialog](/img/kubermatic/v2.25/tutorials/networking/ui-cluster-dialog-konnectivity.png?classes=shadow,border "Cluster Details - Edit Cluster Dialog")
