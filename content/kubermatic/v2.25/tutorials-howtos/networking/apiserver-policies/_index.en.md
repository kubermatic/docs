...
![Allowed IP Ranges - Cluster Creation](/img/kubermatic/v2.25/tutorials/networking/network-config-allowed-ip-ranges.png?height=400px&classes=shadow,border "Allowed IP Ranges - Cluster Creation")

or in an existing cluster via the "Edit Cluster" dialog:

![Allowed IP Ranges - Edit Cluster](/img/kubermatic/v2.25/tutorials/networking/cluster-details-allowed-ip-ranges.png?height=400px&classes=shadow,border "Allowed IP Ranges - Edit Cluster")
