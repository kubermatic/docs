...
![EKS credentials](/img/kubermatic/v2.25/tutorials/external-clusters/eks-credentials.png "EKS credentials")
...
![Select EKS cluster](/img/kubermatic/v2.25/tutorials/external-clusters/select-eks-cluster.png "Select EKS cluster")
...
![Provide Preset Name](/img/kubermatic/v2.25/tutorials/external-clusters/create-ekspreset.png "Provide Preset Name")

- Choose `Elastic Kubernetes Service` from the list of providers.

![Choose EKS Preset](/img/kubermatic/v2.25/tutorials/external-clusters/choose-akspreset.png "Choose EKS Preset")

-  Enter EKS credentials and Click on `Create` button.

![Enter Credentials](/img/kubermatic/v2.25/tutorials/external-clusters/enter-eks-credentials-preset.png "Enter Credentials")

- You can now use created EKS Preset to Create or Import EKS Cluster.

![Select EKS Preset](/img/kubermatic/v2.25/tutorials/external-clusters/existing-eks-preset.png "Select EKS Preset")
...
![EKS cluster](/img/kubermatic/v2.25/tutorials/external-clusters/eks-details.png "EKS cluster")

You can also expand `Events` to get information from the controller.

![Cluster Events](/img/kubermatic/v2.25/tutorials/external-clusters/eks-cluster-events.png "Cluster Events")

You can also click on `Machine Deployments` to get the details:

![EKS Machine Deployment](/img/kubermatic/v2.25/tutorials/external-clusters/eks-machine-deployments.png "EKS Machine Deployment")
...
![Upgrade Available](/img/kubermatic/v2.25/tutorials/external-clusters/eks-upgrade-available.png "Upgrade Available")

![Upgrade EKS](/img/kubermatic/v2.25/tutorials/external-clusters/upgrade-eks.png "Upgrade EKS")
...
![Update EKS Machine Deployment](/img/kubermatic/v2.25/tutorials/external-clusters/edit-md.png "Update EKS Machine Deployment")
...
![Update EKS Machine Deployment](/img/kubermatic/v2.25/tutorials/external-clusters/edit-eks-md.png "Update EKS Machine Deployment")
...
![Delete Cluster](/img/kubermatic/v2.25/tutorials/external-clusters/eks-disconnect-button.png
 "Delete Cluster")
...
![Update EKS Machine Deployment](/img/kubermatic/v2.25/tutorials/external-clusters/delete-md.png "Delete EKS Machine Deployment")
