...
![Cluster Details View](/img/kubermatic/v2.25/ui/opa-cluster-view.png?height=500px&classes=shadow,border "Cluster Details View")

![Constraints Cluster View](/img/kubermatic/v2.25/ui/opa-constraints-cluster.png?classes=shadow,border "Constraints Cluster View")
...
![Add Constraints Dialog](/img/kubermatic/v2.25/ui/opa-add-constraint.png?height=350px&classes=shadow,border "Add Constraints Dialog")
...
![Default Constraints](/img/kubermatic/v2.25/ui/default-constraint-admin.png?height=300px&classes=shadow,border "Default Constraints")
...
![Disable Default Constraint](/img/kubermatic/v2.25/ui/default-constraint-on.png?height=200px&classes=shadow,border "Disable Default Constraint")

Enable the constraint by clicking the same button
![Enable Default Constraint](/img/kubermatic/v2.25/ui/disabled-default-constraint.png?height=200px&classes=shadow,border "Enable Default Constraint")
...
![Allowed Registry Default Constraint](/img/kubermatic/v2.25/ui/allowed-registry-default-constraint.png?classes=shadow,border "Allowed Registry Default Constraint")
