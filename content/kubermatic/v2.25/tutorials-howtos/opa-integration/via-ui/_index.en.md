...
![Access Admin Panel](/img/kubermatic/v2.25/ui/admin-panel.png?classes=shadow,border "Accessing the Admin Panel")
...
![Admin OPA Options](/img/kubermatic/v2.25/ui/opa-admin-options.png?classes=shadow,border "Admin OPA Options")
...
![Cluster Details View](/img/kubermatic/v2.25/ui/opa-cluster-view.png?classes=shadow,border "Cluster Details View")
...
![OPA Integration during Cluster Creation](/img/kubermatic/v2.25/ui/opa-enable.png?classes=shadow,border "OPA Integration during Cluster Creation")
...
![Cluster Details Ellipsis Menu](/img/kubermatic/v2.25/ui/edit-cluster-menu.png?classes=shadow,border "Cluster Details Ellipsis Menu")

In the appearing dialog, you can now enable/disable the OPA Integration.

![Edit Cluster Dialog](/img/kubermatic/v2.25/ui/edit-cluster-dialog.png?classes=shadow,border "Edit Cluster Dialog")
...
![Edit Constraint Template](/img/kubermatic/v2.25/ui/edit-constraint-template.png?classes=shadow,border "Cluster Details View")
...
![Constraints](/img/kubermatic/v2.25/ui/opa-constraints-cluster.png?classes=shadow,border "Constraints")
...
![Add Constraints Dialog](/img/kubermatic/v2.25/ui/opa-add-constraint.png?classes=shadow,border "Add Constraints Dialog")
...
![Constraints](/img/kubermatic/v2.25/ui/cluster-opa-constraints-overview.png?classes=shadow,border "Constraints")

It also shows you possible violations. Click on the row to expand the view and to see all violations in detail.

![Violations](/img/kubermatic/v2.25/ui/opa-created-constraints-violations.png?classes=shadow,border "Violations")
...
![Disabled Constraint Spec](/img/kubermatic/v2.25/ui/disabled-constraint-spec.png?classes=shadow,border "Disabled Constraint Spec")

Disabled Kubermatic Constraint on a Cluster is blurred to differentiate between Enabled and Disabled Constraints

![Disabled Constraint](/img/kubermatic/v2.25/ui/cluster-disabled-constraint.png?classes=shadow,border "Disabled Constraint")
...
![Disabled Default Constraint](/img/kubermatic/v2.25/ui/default-constraint-default-true.png?height=400px&classes=shadow,border "Disabled Default Constraint")
...
![Allowed Registries View](/img/kubermatic/v2.25/ui/allowed-registries.png?classes=shadow,border "Allowed Registry View")
...
![Allowed Registries Create](/img/kubermatic/v2.25/ui/add-allowed-registry.png?classes=shadow,border "Add Allowed Registry")
...
![Allowed Registries Default Constraint](/img/kubermatic/v2.25/ui/allowed-registry-default-constraint.png?classes=shadow,border "Allowed Registry Default Constraint")
...
![Gatekeeper Config](/img/kubermatic/v2.25/ui/opa-config.png?classes=shadow,border "Gatekeeper Config")

Click on this button to create a config. A new dialog will appear, where you can insert your spec:

![Add Gatekeeper Config](/img/kubermatic/v2.25/ui/opa-add-config.png?height=350px&classes=shadow,border "Add Gatekeeper Config")
...
![Gatekeeper Config](/img/kubermatic/v2.25/ui/opa-config-overview.png?classes=shadow,border "Gatekeeper Config")
