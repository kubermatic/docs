...
![MLA Admin Panel](/img/kubermatic/v2.25/monitoring/user-cluster/admin-panel.png)
...
![MLA UI - Cluster View](/img/kubermatic/v2.25/monitoring/user-cluster/ui-cluster-view.png)
