...
![MLA UI - Cluster Create](/img/kubermatic/v2.25/monitoring/user-cluster/ui-cluster-create.png)
...
![KKP UI - Addons](/img/kubermatic/v2.25/monitoring/user-cluster/ui-addons.png)

![KKP UI - Addons](/img/kubermatic/v2.25/monitoring/user-cluster/ui-addons-select.png)
...
![Grafana UI - Organizations](/img/kubermatic/v2.25/monitoring/user-cluster/ui-grafana-orgs.png)

![Grafana UI - Organizations](/img/kubermatic/v2.25/monitoring/user-cluster/ui-grafana-orgs2.png)
...
![Grafana UI - Datasources](/img/kubermatic/v2.25/monitoring/user-cluster/ui-grafana-datasources.png)

### Grafana Dashboards

There are some pre-installed Grafana Dashboards which can be found in Grafana UI under Dashboards -> Manage:

![Grafana UI - Dashboards](/img/kubermatic/v2.25/monitoring/user-cluster/ui-grafana-dashboards.png)
...
![KKP UI - Alertmanager](/img/kubermatic/v2.25/monitoring/user-cluster/ui-alertmanager.png)
...
![KKP UI - Alerting Rules](/img/kubermatic/v2.25/monitoring/user-cluster/ui-alert-rules.png)
...
![KKP UI - Alerting Rules Data](/img/kubermatic/v2.25/monitoring/user-cluster/ui-alert-rules-data.png)
