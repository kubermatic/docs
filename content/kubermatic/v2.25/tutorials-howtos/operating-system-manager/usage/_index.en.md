...
![Enable OSM during cluster creation](/img/kubermatic/v2.25/tutorials/operating-system-manager/osm-dashboard.png?classes=shadow,border "Enable OSM during cluster creation")
...
![Select OperatingSystemProfile](/img/kubermatic/v2.25/tutorials/operating-system-manager/osm-select.png?classes=shadow,border "Select OperatingSystemProfile")
