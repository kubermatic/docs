...
![Admission Plugin Selection](/img/kubermatic/v2.25/ui/admission-plugins.png?height=400px&classes=shadow,border "Admission Plugin Selection")
...
![PodNodeSelector Admission Plugin Configuration](/img/kubermatic/v2.25/ui/admission-plugin-configuration.png?classes=shadow,border "PodNodeSelector Admission Plugin Configuration")
...
![EventRateLimit Admission Plugin Configuration](/img/kubermatic/v2.25/ui/admission-plugin-configuration-eventratelimit.png?height=200px&classes=shadow,border "EventRateLimit Admission Plugin Configuration")
