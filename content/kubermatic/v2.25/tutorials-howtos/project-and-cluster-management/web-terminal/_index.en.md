...
![Web Terminal](/img/kubermatic/v2.25/ui/web-terminal.png?classes=shadow,border)
...
![Web Terminal sequence diagram](/img/kubermatic/v2.25/ui/web-terminal-sequence-diagram.png?classes=shadow,border)
