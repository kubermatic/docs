...
![Download config button in the top right corner](/img/kubermatic/v2.25/tutorials/cluster-details-btn.png?classes=shadow,border "Download config button in the top right corner")
...
![Select Revoke Token](/img/kubermatic/v2.25/tutorials/revoke-token-cluster.png?classes=shadow,border "Select Revoke Token")
...
![Revoke the token](/img/kubermatic/v2.25/tutorials/revoke-token-dialog.png?classes=shadow,border "Revoke the token")
