...
![Project List](/img/kubermatic/v2.25/tutorials/projects-overview.png?classes=shadow,border "Project List")

Assign your new project a name:

![Add Project Dialog](/img/kubermatic/v2.25/tutorials/project-add.png?classes=shadow,border "Add Project Dialog")
...
![Delete Project](/img/kubermatic/v2.25/tutorials/project-delete.png?classes=shadow,border "Delete Project")
...
![SSH Key List](/img/kubermatic/v2.25/tutorials/sshkeys-overview.png?classes=shadow,border "SSH Key List")

This will create a pop up. Enter a unique name and paste the complete content of the SSH key into the respective field:

![Add SSH Key Dialog](/img/kubermatic/v2.25/tutorials/sshkeys-add-dialog.png?classes=shadow,border "Add SSH Key Dialog")
...
![Cluster List](/img/kubermatic/v2.25/tutorials/cluster-list.png?classes=shadow,border "Cluster List")

Choose the cloud provider and the datacenter:

![Menu to choose Cloud Provider](/img/kubermatic/v2.25/tutorials/wizard-step-1.png?classes=shadow,border "Menu to choose Cloud Provider")
...
![General Cluster Settings](/img/kubermatic/v2.25/tutorials/wizard-step-2.png?classes=shadow,border "General Cluster Settings")
...
![Provider Credentials](/img/kubermatic/v2.25/tutorials/wizard-step-3.png?classes=shadow,border "Provider Credentials")
...
![Node Settings](/img/kubermatic/v2.25/tutorials/wizard-step-4.png?classes=shadow,border "Node Settings")
![Node Settings](/img/kubermatic/v2.25/tutorials/wizard-step-4.1.png?classes=shadow,border "Node Settings")
...
![Add Applications to a cluster Settings](/img/kubermatic/v2.25/tutorials/wizard-step-5.png?classes=shadow,border "Add Applications")

Lastly, a cluster summary screen will be presented so that you can check out if everything looks ok.

![Cluster Details as a Summary](/img/kubermatic/v2.25/tutorials/wizard-step-6.png?classes=shadow,border "Cluster Details as a Summary")

You will then be forwarded to the cluster page where you can view the cluster creation process:

![Cluster Details in Creation State](/img/kubermatic/v2.25/tutorials/cluster-details-after-creation.png?classes=shadow,border "Cluster Details in Creation State")
...
![Cluster Created](/img/kubermatic/v2.25/tutorials/cluster-details-overview.png?classes=shadow,border "Cluster Created")
...
![Cluster with available Upgrade](/img/kubermatic/v2.25/tutorials/upgrade-version.png?classes=shadow,border "Cluster with available Upgrade")

To start the upgrade, just click on the link and choose the desired version:

![Dialog to choose Upgrade Version](/img/kubermatic/v2.25/tutorials/change-version.png?classes=shadow,border "Dialog to choose Upgrade Version")
...
![Select Edit Cluster](/img/kubermatic/v2.25/tutorials/cluster-edit-menu.png?classes=shadow,border "Select Edit Cluster")

![Edit Cluster Dialog](/img/kubermatic/v2.25/tutorials/edit-cluster-dialog.png?classes=shadow,border "Edit Cluster Dialog")
...
![Cluster Deletion Button in the top right corner](/img/kubermatic/v2.25/tutorials/delete-cluster-button.png?classes=shadow,border "Cluster Deletion Button in the top right corner")

To confirm the deletion, type the name of the cluster into the text box:

![Confirmation dialog for Cluster Deletion](/img/kubermatic/v2.25/tutorials/delete-cluster.png?classes=shadow,border "Confirmation dialog for Cluster Deletion")
...
![Cluster overview with highlighted add button](/img/kubermatic/v2.25/tutorials/add-machine-deployment.png?classes=shadow,border "Cluster overview with highlighted add button")
...
![Machine deployment overview with highlighted edit button](/img/kubermatic/v2.25/tutorials/machine-deployment-edit.png?classes=shadow,border "Machine deployment overview with highlighted edit button")
...
![Machine deployment overview with opened edit modal](/img/kubermatic/v2.25/tutorials/machine-deployment-edit-dialog.png?classes=shadow,border "Machine deployment overview with opened edit modal")
