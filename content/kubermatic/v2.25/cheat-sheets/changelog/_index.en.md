...
![Opening Changelog](/img/kubermatic/v2.25/ui/opening-changelog.png?classes=shadow,border)

An example changelog might look like the one below.

![Changelog](/img/kubermatic/v2.25/ui/changelog.png?classes=shadow,border)
