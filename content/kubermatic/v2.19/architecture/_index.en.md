...
![KKP Architecture Diagram](/img/kubermatic/v2.19/architecture/combined-master-seed.png)
...
![KKP Architecture Diagram](/img/kubermatic/v2.19/architecture/dedicated-seeds.png)
...
See the [installation documentation]({{< relref "../installation/install_kkp_ce/">}}) for more details on how to setup datacenters.
