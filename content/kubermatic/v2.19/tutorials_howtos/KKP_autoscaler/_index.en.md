...
Create a KKP Cluster by selecting your project on the dashboard and click on `“create cluster”`. More details can be found on the official [documentation](https://docs.kubermatic.com/kubermatic/v2.19/tutorials_howtos/project_and_cluster_management/) page.

**Step 2**

When the Cluster is ready, check the Pods in the kube-system Namespace to know if any Autoscaler is running.

![KKP Dashboard](/img/kubermatic/v2.19/tutorials/kkp_autoscaler_dashboard.png?classes=shadow,border "KKP Dashboard")
...
![Add Addon](/img/kubermatic/v2.19/tutorials/add_autoscaler_addon.png?classes=shadow,border "Add Addon")


Select Cluster Autoscaler:


![Select Autoscaler](/img/kubermatic/v2.19/tutorials/select_autoscaler.png?classes=shadow,border "Select Autoscaler")


Select install:


![Select Install](/img/kubermatic/v2.19/tutorials/install_autoscaler.png?classes=shadow,border "Select Install")



![Installation Confirmation](/img/kubermatic/v2.19/tutorials/autoscaler_confirmation.png?classes=shadow,border "Installation Confirmation")
...
![Edit Autoscaler](/img/kubermatic/v2.19/tutorials/edit_autoscaler.png?classes=shadow,border "Edit Autoscaler")
...
![Delete Autoscaler](/img/kubermatic/v2.19/tutorials/delete_autoscaler.png?classes=shadow,border "Delete Autoscaler")
