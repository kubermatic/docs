...
![Wizard cluster specification step](/img/2.14/getting_started/manage_projects/projects-list.png)
...
![Wizard cluster specification step](/img/2.14/getting_started/create_cluster/wizard-spec.png)
...
![Wizard provider step](/img/2.14/getting_started/create_cluster/wizard-provider.png)
...
![Wizard datacenter step](/img/2.14/getting_started/create_cluster/wizard-dc.png)
...
![Wizard settings step](/img/2.14/getting_started/create_cluster/wizard-settings.png)
...
![Wizard summary step](/img/2.14/getting_started/create_cluster/wizard-summary.png)
