...
Log into Kubermatic and create a cluster. For this tutorial you will need to see the external IP, be aware that some providers like DigitalOcean do not provide external IPs.
