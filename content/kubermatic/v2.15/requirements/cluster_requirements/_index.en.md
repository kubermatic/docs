...
### Master Cluster
The Master Cluster hosts the KKP components and might also act as a seed cluster and host the master components of user clusters (see [Architecture](../../concepts/architecture)). Therefore, it should run in [Highly Available setup](../../installation/install_kubernetes) with at least 3 master nodes and 3 worker nodes.
