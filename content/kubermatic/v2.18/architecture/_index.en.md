...
![KKP Architecture Diagram](/img/kubermatic/v2.18/architecture/combined-master-seed.png)
...
![KKP Architecture Diagram](/img/kubermatic/v2.18/architecture/dedicated-seeds.png)
...
See the [installation documentation]({{< ref "../installation/install_kkp_ce/">}}) for more details on how to setup datacenters.
