...
![Download config button in the top right corner](/img/kubermatic/v2.22/tutorials/cluster_details_btn.png?classes=shadow,border "Download config button in the top right corner")
...
![Revoke the token](/img/kubermatic/v2.22/tutorials/revoke_token_dialog.png?classes=shadow,border "Revoke the token")
