...
![Applications Tab](/img/kubermatic/v2.22/applications/applications_edit_icon.png?classes=shadow,border "Applications edit button")
...
![Applications Tab](/img/kubermatic/v2.22/applications/applications_edit_values.png?classes=shadow,border "Applications edit values and version")
