...
![Interface](/img/kubermatic/v2.22/ui/interface.png?classes=shadow,border)
...
![Enable External Cluster](/img/kubermatic/v2.22/ui/enable_external_clusters.png?classes=shadow,border)
...
![External Cluster on the Cluster List](/img/kubermatic/v2.22/ui/external_cluster.png?classes=shadow,border)

#### External Cluster Details

![External Cluster Details](/img/kubermatic/v2.22/ui/external_cluster_details.png?classes=shadow,border)

## Enable Kubernetes Dashboard

![Enable Kubernetes Dashboard](/img/kubermatic/v2.22/ui/enable_kubernetes_dashboard.png?classes=shadow,border)
...
![Cluster Details](/img/kubermatic/v2.22/ui/cluster_details.png?height=300px&classes=shadow,border)

## Enable OIDC Kubeconfig

![Enable OIDC Kubeconfig](/img/kubermatic/v2.22/ui/enable_oidc_kubeconfig.png?classes=shadow,border)
...
![Get Kubeconfig](/img/kubermatic/v2.22/ui/get_kubeconfig.png?classes=shadow,border)

## Enable Web Terminal

![Enable Web Terminal](/img/kubermatic/v2.22/ui/enable_web_terminal.png?classes=shadow,border)
...
![Web Terminal](/img/kubermatic/v2.22/ui/web_terminal_button.png?classes=shadow,border)
