...
![Add Datacenter](/img/kubermatic/v2.22/ui/dc_add1.png?classes=shadow,border&height=600 "Dynamic Datacenters Add Dialog")

and add the provider spec based on the Datacenter provider:
![Add Datacenter Provider](/img/kubermatic/v2.22/ui/dc_add2.png?classes=shadow,border&height=600 "Dynamic Datacenters Add Dialog")

The added datacenter can easily be found with the filtering functions:
![Find Datacenter](/img/kubermatic/v2.22/ui/dc_filter.png?classes=shadow,border "Filter Datacenters")
...
![Use Datacenter](/img/kubermatic/v2.22/ui/wizard_step1.png?classes=shadow,border "Use Datacenter during Cluster Creation")
