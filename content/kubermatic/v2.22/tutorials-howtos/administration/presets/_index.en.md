...
![](/img/kubermatic/v2.22/ui/preset_management.png?height=300px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/create_preset.png?height=300px&classes=shadow,border)

#### Step 1: Preset

![](/img/kubermatic/v2.22/ui/create_preset_first_step.png?height=500px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/create_preset_second_step.png?height=500px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/create_preset_third_step.png?height=500px&classes=shadow,border)

There are provider specific fields available here. Some of them will be mandatory as they are needed for the cluster
creation.

![](/img/kubermatic/v2.22/ui/create_preset_third_step_dc.png?height=200px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/datacenter_names.png?height=300px&classes=shadow,border "Dynamic Datacenter Names")
...
![](/img/kubermatic/v2.22/ui/add_provider.png?height=300px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/add_provider_first_step.png?height=500px&classes=shadow,border)

#### Step 2: Settings

Provider specific fields will be available to fill out, same as during the Preset creation process.

![](/img/kubermatic/v2.22/ui/add_provider_second_step.png?height=500px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/edit_provider.png?height=250px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/edit_provider_first_step.png?height=350px&classes=shadow,border)

#### Step 2: Settings

Provider specific fields will be available to fill out, same as during the Preset creation process.

![](/img/kubermatic/v2.22/ui/edit_provider_second_step.png?height=500px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/edit_preset.png?height=250px&classes=shadow,border)
...
![](/img/kubermatic/v2.22/ui/edit_preset_dialog.png?height=400px&classes=shadow,border)
