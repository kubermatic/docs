...
![Manage Quotas](/img/kubermatic/v2.22/architecture/concepts/resource-quotas/quota-menu.png?classes=shadow,border "Manage Quotas")
...
![Enforced Quota](/img/kubermatic/v2.22/architecture/concepts/resource-quotas/enforced.png?classes=shadow,border "Enforced Quota")

Furthermore, a project quota widget of the active project is visible in the dashboard, which shows what is the quota usage.

![Quota Widget](/img/kubermatic/v2.22/architecture/concepts/resource-quotas/widget.png?classes=shadow,border "Quota Widget")
