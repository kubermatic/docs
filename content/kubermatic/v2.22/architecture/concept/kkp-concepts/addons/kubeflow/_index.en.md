...
![Kubeflow Addon](/img/kubermatic/v2.22/ui/addon_add.png?height=400px&classes=shadow,border "Kubeflow Addon")

The UI will provide several options that can be used to customize the Kubeflow installation, as shown below.

![Kubeflow Addon Details](/img/kubermatic/v2.22/ui/addon_details.png?height=450px&classes=shadow,border "Kubeflow Addon Details")
