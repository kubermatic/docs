...
![KubeVirt Cloud Provider Architecture](/img/kubermatic/v2.22/architecture/supported-providers/kubevirt/architecture.png?classes=shadow,border "KubeVirt Cloud Provider Architecture")
...
![Instance Types and Preferences](/img/kubermatic/v2.22/architecture/supported-providers/kubevirt/instance-type.png?classes=shadow,border "Instance Types and Preferences")
...
![Instance Types and Preferences](/img/kubermatic/v2.22/architecture/supported-providers/kubevirt/scheduling-form.png?classes=shadow,border "Advanced Scheduling Settings")
...
![Machine Deployment Edit](/img/kubermatic/v2.22/architecture/supported-providers/kubevirt/mc-edit.png?classes=shadow,border "Machine Deployment Edit")
