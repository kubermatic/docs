...
![Addons](/img/kubermatic/v2.21/ui/addons_overview.png?classes=shadow,border "Addons View")
...
![Addon Form](/img/kubermatic/v2.21/ui/addon_form.png?height=450px&classes=shadow,border "Addon Form")
...
```
{{< readfile "kubermatic/v2.21/data/addondata.go" >}}
```
