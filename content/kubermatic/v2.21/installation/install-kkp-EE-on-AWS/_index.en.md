...
The installation procedure is identical to the [Community Edition]({{< ref "../install-kkp-CE-on-AWS" >}}), with the exception that
...
* [Add a Seed cluster]({{< ref "./add-seed-cluster-ee-on-aws" >}}) to start creating user clusters.
