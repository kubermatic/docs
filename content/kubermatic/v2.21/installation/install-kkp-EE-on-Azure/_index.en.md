...
The installation procedure is identical to the [Community Edition]({{< ref "../install-kkp-CE-on-Azure" >}}), with the exception that
...
* [Add a Seed cluster on Azure]({{< ref "./add-seed-cluster-ee-on-azure" >}}) to start creating user clusters.
