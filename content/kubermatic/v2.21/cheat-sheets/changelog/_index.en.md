...
![Opening Changelog](/img/kubermatic/v2.21/ui/opening_changelog.png?classes=shadow,border)

An example changelog might look like the one below.

![Changelog](/img/kubermatic/v2.21/ui/changelog.png?classes=shadow,border)
