...
![Administrators](/img/kubermatic/v2.21/ui/admins.png?classes=shadow,border "Administrators View")
...
![Add Administrator](/img/kubermatic/v2.21/ui/admin_add.png?classes=shadow,border&height=200 "Administrator Add Dialog")
...
![Delete Administrator](/img/kubermatic/v2.21/ui/admin_delete.png?classes=shadow,border&height=200 "Administrator Delete Dialog")
