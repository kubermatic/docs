...
![Cluster Settings - Network Configuration](/img/kubermatic/v2.21/tutorials/networking/ui_cluster_networking.png?classes=shadow,border "Cluster Settings - Network Configuration")
...
![Cluster Settings - Network Configuration](/img/kubermatic/v2.21/tutorials/networking/ui_cluster_cni.png?classes=shadow,border "Cluster Settings - Network Configuration")
...
![Cluster Details - Addons](/img/kubermatic/v2.21/tutorials/networking/ui_addons.png?classes=shadow,border "Cluster Details - Addons")

![Cluster Details - Addons - Install Addon](/img/kubermatic/v2.21/tutorials/networking/ui_addon_hubble.png?classes=shadow,border "Cluster Details - Addons - Install Addon")
...
![Cluster Details](/img/kubermatic/v2.21/tutorials/networking/ui_cni_upgrade_available.png?classes=shadow,border "Cluster Details")

![Cluster Details - CNI Plugin Version Dialog](/img/kubermatic/v2.21/tutorials/networking/ui_cni_upgrade_dialog.png?classes=shadow,border "Cluster Details - CNI Plugin Version Dialog")
...
![Cluster Settings - Advanced Network Configuration](/img/kubermatic/v2.21/tutorials/networking/ui_cluster_networking_advanced.png?classes=shadow,border "Cluster Settings - Network Configuration")
...
![Cluster Settings - Network Configuration](/img/kubermatic/v2.21/tutorials/networking/ui_cluster_konnectivity.png?classes=shadow,border "Cluster Settings - Network Configuration")
...
![Cluster Details - Edit Cluster Dialog](/img/kubermatic/v2.21/tutorials/networking/ui_cluster_dialog_konnectivity.png?classes=shadow,border "Cluster Details - Edit Cluster Dialog")
