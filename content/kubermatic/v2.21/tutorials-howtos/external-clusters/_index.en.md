...
![Custom Cluster](/img/kubermatic/v2.21/tutorials/external_clusters/custom_details.png "Custom Cluster")
...
![External Cluster Reconciling State](/img/kubermatic/v2.21/tutorials/external_clusters/aks_reconcile.png "External Cluster Reconciling State")

### Deleted Cluster

If you delete the cluster from the provider, the state in KKP will be shown as `Deleting`.
![External Cluster Delete State](/img/kubermatic/v2.21/tutorials/external_clusters/delete_status.png "External Cluster Delete State")
...
![Disconnect Deleted External Cluster](/img/kubermatic/v2.21/tutorials/external_clusters/disconnect_deleted_cluster.png "Disconnect Deleted External Cluster")
