...
![Applications Tab](/img/kubermatic/v2.21/applications/application_section.png "Applications Tab")
...
![Application Catalogue](/img/kubermatic/v2.21/applications/application-catalogue.png "Application Catalogue")

After choosing an Application, its installation can be further customized.

![Application Settings](/img/kubermatic/v2.21/applications/application_settings.png "Application Settings")

![Application Values](/img/kubermatic/v2.21/applications/application_values.png "Application Values")
...
![Application Installation Status](/img/kubermatic/v2.21/applications/application_status.png "Application Installation Status")
...
![Application Section in Cluster Creation Wizard](/img/kubermatic/v2.21/applications/applications_flow_in_cluster_wizard.png "Application Section in Cluster Creation Wizard")
...
![Saving As Cluster Template](/img/kubermatic/v2.21/applications/save_to_cluster_template.png "Saving As Cluster Template")
