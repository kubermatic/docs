...
After deploying MLA components into a KKP Seed cluster, Grafana and Alertmanager UI are exposed only via ClusterIP services by default. To expose them to users outside of the Seed cluster with proper authentication in place, we will use the [IAP Helm chart](https://github.com/kubermatic/kubermatic/tree/release/v2.21/charts/iap) from the Kubermatic repository.
...
![MLA Admin Panel](/img/kubermatic/v2.21/monitoring/user_cluster/admin_panel.png)
...
![MLA UI - Cluster View](/img/kubermatic/v2.21/monitoring/user_cluster/ui_cluster_view.png)
