...
![EventRateLimit Admission Plugin Configuration](@/images/ui/admission-plugin-configuration-eventratelimit.png?height=200px&classes=shadow,border "EventRateLimit Admission Plugin Configuration")
