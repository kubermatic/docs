...
INFO[0000] 🚀 Starting mirroring the binaries            
INFO[0007] ✅ CNI plugins download complete.             
INFO[0011] ✅ CRI tools download complete for all available Kubernetes versions. 
INFO[0049] ✅ Kube binaries download complete for all available Kubernetes versions. 
INFO[0049] ✅ Finished loading images.      
```
