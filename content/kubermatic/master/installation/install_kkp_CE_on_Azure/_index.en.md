+++
title = "Install Kubermatic Kubernetes Platform (KKP) CE on Azure"
date = 2022-06-14T12:07:15+02:00
weight = 60

+++

This chapter explains the installation procedure of KKP into a pre-existing Kubernetes cluster on Azure Cloud Provider using installer.
...
and make yourself familiar with the requirements for your Azure cloud provider.
...
The `EXTERNAL-IP` is what we need to put into the DNS record. Note that this can be a IP address (for example on Azure,
...
* [Add a Seed cluster on Azure]({{< ref "./add_seed_cluster_CE_on_Azure" >}}) to start creating user clusters.
