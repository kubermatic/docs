...
The installation procedure is identical to the [Community Edition]({{< ref "../install_kkp_CE_on_GCP" >}}), with the exception that
...
* [Add a Seed cluster on GCP]({{< ref "./add_seed_cluster_ee_on_gcp" >}}) to start creating user clusters.
