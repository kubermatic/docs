...
![Kubeflow Addon](/img/kubermatic/master/advanced/addons/kubeflow/addon.png)

The UI will provide several options that can be used to customize the Kubeflow installation, as shown below.

![Kubeflow Addon Details](/img/kubermatic/master/advanced/addons/kubeflow/addon-details.png)
