...
![View](/img/kubermatic/master/advanced/admission_plugins_configuration/select.png)


### PodNodeSelector configuration
Selecting `PodNodeSelector` plugin expands an additional view for the plugin configuration.

![View](/img/kubermatic/master/advanced/admission_plugins_configuration/configuration.png)
