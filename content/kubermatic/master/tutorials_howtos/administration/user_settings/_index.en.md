...
* `Theme` lists all available themes for the dashboard so the user can select its preferred one. Read chapter [Customizing the Dashboard Theme](../../user_interface/theming/) to learn more about themes.
