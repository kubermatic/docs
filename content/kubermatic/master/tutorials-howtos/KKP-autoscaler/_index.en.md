...
Create a KKP Cluster by selecting your project on the dashboard and click on `“create cluster”`. More details can be found on the official [documentation](https://docs.kubermatic.com/kubermatic/master/tutorials-howtos/project-and-cluster-management/) page.  
...
* You can easily provision a Kubernetes Cluster using [KKP here](https://docs.kubermatic.com/kubermatic/v2.17/tutorials-howtos/project-and-cluster-management/)
