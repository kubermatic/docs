...
To do so via  cli, simply follow the guide in the machine-controller [documentation](https://docs.kubermatic.com/kubeone/master/cheat-sheets/rollout_machinedeployment/).
