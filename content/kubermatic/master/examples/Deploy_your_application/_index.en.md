...
Log into Kubermatic Kubernetes Platform (KKP), then [create and connect to the cluster](/kubermatic/master/tutorials_howtos/project_and_cluster_management/). For this tutorial, external IP is required which will be provided through the supported cloud providers. Be aware that some providers like DigitalOcean do not provide external IPs.
