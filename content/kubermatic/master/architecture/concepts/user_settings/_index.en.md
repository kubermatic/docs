...
![User menu](/img/kubermatic/master/architecture/concepts/user-settings/menu.png)

### User Settings Overview

![User settings view](/img/kubermatic/master/architecture/concepts/user-settings/view.png)
...
* `Theme` lists all available themes for the dashboard so the user can select its preferred one. Read chapter [Customizing the Dashboard Theme]({{< ref "#" >}}) to learn more about themes.
