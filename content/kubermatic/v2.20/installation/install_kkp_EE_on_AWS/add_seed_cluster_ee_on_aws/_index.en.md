...
#nodeport-proxy   LoadBalancer   10.47.248.232   EXAMPLEEXAMPLEEXAMPLEEXAMPLE-EXAMPLE.eu-west-2.elb.amazonaws.com     80:32014/TCP,443:30772/TCP   449d
```
...
```plain
*.europe-west3.kubermatic.example.com.   IN   CNAME   EXAMPLEEXAMPLEEXAMPLEEXAMPLE-EXAMPLE.eu-west-2.elb.amazonaws.com .
```
