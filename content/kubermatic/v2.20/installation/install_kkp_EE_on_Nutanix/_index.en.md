+++
title = "Install Kubermatic Kubernetes Platform (KKP) EE on Nutanix"
...
The installation procedure is identical to the [Community Edition]({{< ref "../install_kkp_CE_on_Nutanix" >}}), with the exception that
...
Follow the CE install guide on nutanix as normal, the remaining steps apply equally to the Enterprise Edition.

### Next Steps

* [Add a Seed cluster]({{< ref "./add_seed_cluster_ee_on_nutanix" >}}) to start creating user clusters.
