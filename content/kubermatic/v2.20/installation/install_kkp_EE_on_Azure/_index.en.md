...
The installation procedure is identical to the [Community Edition]({{< ref "../install_kkp_CE_on_Azure" >}}), with the exception that
...
* [Add a Seed cluster on Azure]({{< ref "./add_seed_cluster_ee_on_azure" >}}) to start creating user clusters.
