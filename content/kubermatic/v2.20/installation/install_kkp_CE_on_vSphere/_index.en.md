+++
title = "Install Kubermatic Kubernetes Platform (KKP) CE on vSphere"
date =  2022-06-20T01:30:56+05:00
weight = 5
+++

This chapter explains the installation procedure of KKP into a pre-existing Kubernetes cluster on vSphere using installer.
...
* [Add a Seed cluster]({{< ref "./add_seed_cluster_CE_on_vSphere" >}}) to start creating user clusters.
