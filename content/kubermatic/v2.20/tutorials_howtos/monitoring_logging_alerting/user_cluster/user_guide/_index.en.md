...
![MLA UI - Cluster Create](/img/kubermatic/v2.20/monitoring/user_cluster/ui_cluster_create.png)
...
![KKP UI - Addons](/img/kubermatic/v2.20/monitoring/user_cluster/ui_addons.png)

![KKP UI - Addons](/img/kubermatic/v2.20/monitoring/user_cluster/ui_addons_select.png)
...
![Grafana UI - Organizations](/img/kubermatic/v2.20/monitoring/user_cluster/ui_grafana_orgs.png)

![Grafana UI - Organizations](/img/kubermatic/v2.20/monitoring/user_cluster/ui_grafana_orgs2.png)
...
![Grafana UI - Datasources](/img/kubermatic/v2.20/monitoring/user_cluster/ui_grafana_datasources.png)

### Grafana Dashboards

There are some pre-installed Grafana Dashboards which can be found in Grafana UI under Dashboards -> Manage:

![Grafana UI - Dashboards](/img/kubermatic/v2.20/monitoring/user_cluster/ui_grafana_dashboards.png)
...
![KKP UI - Alertmanager](/img/kubermatic/v2.20/monitoring/user_cluster/ui_alertmanager.png)
...
![KKP UI - Alerting Rules](/img/kubermatic/v2.20/monitoring/user_cluster/ui_alert_rules.png)
...
![KKP UI - Alerting Rules Data](/img/kubermatic/v2.20/monitoring/user_cluster/ui_alert_rules_data.png)
