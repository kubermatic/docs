...
![](/img/kubermatic/v2.20/ui/cluster_settings.png?height=300px&classes=shadow,border)
...
![](/img/kubermatic/v2.20/ui/cleanup_on_cluster_deletion.png?classes=shadow,border)

This section controls cluster cleanup settings available inside cluster delete dialog.

![](/img/kubermatic/v2.20/ui/delete_cluster_dialog.png?height=200px&classes=shadow,border)
...
![](/img/kubermatic/v2.20/ui/machine_deployment.png?classes=shadow,border)
...
![](/img/kubermatic/v2.20/ui/wizard_initial_nodes_step.png?height=300px&classes=shadow,border)

## Enable Kubernetes Dashboard

![](/img/kubermatic/v2.20/ui/enable_kubernetes_dashboard.png?classes=shadow,border)
...
#### Cluster Details
![](/img/kubermatic/v2.20/ui/cluster_details.png?height=300px&classes=shadow,border)

## Enable OIDC Kubeconfig

![](/img/kubermatic/v2.20/ui/enable_oidc_kubeconfig.png?classes=shadow,border)
...
![](/img/kubermatic/v2.20/ui/cluster_details_top.png?classes=shadow,border)

## Enable External Clusters

![](/img/kubermatic/v2.20/ui/enable_external_clusters.png?classes=shadow,border)
...
![](/img/kubermatic/v2.20/ui/external_cluster.png?classes=shadow,border)

#### External Cluster Details
![](/img/kubermatic/v2.20/ui/external_cluster_details.png?classes=shadow,border)

## User Projects Limit

![](/img/kubermatic/v2.20/ui/user_projects_limit.png?classes=shadow,border)
...
![](/img/kubermatic/v2.20/ui/resource_quota.png?classes=shadow,border)
