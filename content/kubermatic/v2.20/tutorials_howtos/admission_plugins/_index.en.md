...
![Admission Plugin Selection](/img/kubermatic/v2.20/ui/admission_plugins.png?height=400px&classes=shadow,border "Admission Plugin Selection")
...
![PodNodeSelector Admission Plugin Configuration](/img/kubermatic/v2.20/ui/admission_plugin_configuration.png?classes=shadow,border "PodNodeSelector Admission Plugin Configuration")
...
![EventRateLimit Admission Plugin Configuration](/img/kubermatic/v2.20/ui/admission_plugin_configuration_eventratelimit.png?height=200px&classes=shadow,border "EventRateLimit Admission Plugin Configuration")
