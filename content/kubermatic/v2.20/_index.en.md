...
KKP is directly integrated with leading cloud providers such as [Amazon Web Services](https://docs.kubermatic.com/kubermatic/v2.20/architecture/supported_providers/aws/aws/), [Azure](https://docs.kubermatic.com/kubermatic/v2.20/architecture/supported_providers/azure/azure/), DigitalOcean, [Google Compute Engine](https://docs.kubermatic.com/kubermatic/v2.20/architecture/supported_providers/google_cloud/gcp/), Hetzner, OpenStack, Packet and [VMware vSphere](https://docs.kubermatic.com/kubermatic/v2.20/architecture/supported_providers/vsphere/vsphere/) as well as any provider offering Ubuntu 16.04 or greater, even in your own datacenter.
