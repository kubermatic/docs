...
Worker nodes can be managed via the web dashboard as described [here]({{< ref "../via-dashboard/" >}}). Once you have installed [kubectl]({{< ref "../../../tutorials-howtos/project-and-cluster-management/using-kubectl/" >}}), you can also manage them via the command line interface (CLI) in order to automate creation, deletion and upgrades of nodes.
