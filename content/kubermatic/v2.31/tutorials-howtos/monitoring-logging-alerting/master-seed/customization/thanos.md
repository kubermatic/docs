        ...
        rules:
          - alert: ThanosSidecarDown
            annotations:
              ...
              runbook_url: https://docs.kubermatic.com/kubermatic/v2.31/cheat-sheets/alerting-runbook/#alert-thanossidecardown
          ...
          - alert: ThanosCompactorManyRetries
            annotations:
              ...
              runbook_url: https://docs.kubermatic.com/kubermatic/v2.31/cheat-sheets/alerting-runbook/#alert-thanoscompactormanyretries
          ...
          - alert: ThanosShipperManyDirSyncFailures
            annotations:
              ...
              runbook_url: https://docs.kubermatic.com/kubermatic/v2.31/cheat-sheets/alerting-runbook/#alert-thanosshippermanydirsyncfailures
          ...
          - alert: ThanosManyPanicRecoveries
            annotations:
              ...
              runbook_url: https://docs.kubermatic.com/kubermatic/v2.31/cheat-sheets/alerting-runbook/#alert-thanosmanypanicrecoveries
          ...
          - alert: ThanosManyBlockLoadFailures
            annotations:
              ...
              runbook_url: https://docs.kubermatic.com/kubermatic/v2.31/cheat-sheets/alerting-runbook/#alert-thanosmanyblockloadfailures
          ...
          - alert: ThanosManyBlockDropFailures
            annotations:
              ...
              runbook_url: https://docs.kubermatic.com/kubermatic/v2.31/cheat-sheets/alerting-runbook/#alert-thanosmanyblockdropfailures
