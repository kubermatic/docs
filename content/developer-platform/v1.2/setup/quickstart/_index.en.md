...
```yaml
{{< readfile "developer-platform/v1.2/setup/quickstart/data/letsencrypt.cluster-issuer.yaml" >}}
```
...
```yaml
{{< readfile "developer-platform/v1.2/setup/quickstart/data/gateway.yaml" >}}
```
...
```yaml
{{< readfile "developer-platform/v1.2/setup/quickstart/data/http-routes.yaml" >}}
```
...
```yaml
{{< readfile "developer-platform/v1.2/setup/quickstart/data/dex.values.yaml" >}}
```
...
```yaml
{{< readfile "developer-platform/v1.2/setup/quickstart/data/kcp.values.yaml" >}}
```
...
```yaml
{{< readfile "developer-platform/v1.2/setup/quickstart/data/kdp.values.yaml" >}}
```
...
```yaml
{{< readfile "developer-platform/v1.2/setup/quickstart/data/kdp-dashboard.values.yaml" >}}
```
...
- **Use kubectl with kcp**: Download a kubeconfig from the dashboard (available in the workspace context menu) or set one up manually using the [kcp kubectl plugin](https://docs.kcp.io/kcp/v0.30/setup/kubectl-plugin/). See [kcp on the Command Line]({{< relref "../../tutorials/kcp-command-line" >}}) for a walkthrough.
