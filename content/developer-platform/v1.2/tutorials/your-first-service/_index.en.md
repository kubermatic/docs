...
{{% notice warning %}}
Currently only api-syncagent version 0.3.x is supported. Make sure you pass `--version 0.3.0` when installing the api-syncagent chart and set `image.tag=v0.3.0` in your values.
{{% /notice %}}
