...
$ kubectl apply \
  -f https://raw.githubusercontent.com/kubermatic/kubecarrier/v0.2.0/docs/manifests/couchdb.crd.yaml
...
$ kubectl apply -n team-a \
  -f https://raw.githubusercontent.com/kubermatic/kubecarrier/v0.2.0/docs/manifests/catalogentryset.yaml
...
```bash
$ kubectl apply -n team-a \
  -f https://raw.githubusercontent.com/kubermatic/kubecarrier/v0.2.0/docs/manifests/catalog.yaml
